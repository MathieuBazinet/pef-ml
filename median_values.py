...
def main(exp_vals):
    ...
    plt.savefig("./leaves_number_median_values.jpg")
    plt.close()
    ...
    plt.savefig("./training_scores_median_values.jpg")
    plt.close()
    ...
    plt.savefig("./median_values_heatmaps.jpg")
    plt.close()
    ...
    plt.savefig("./median_values_interval_heatmaps.jpg")
