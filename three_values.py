...
def main(exp_vals):
    ...
    plt.savefig("./leaves_number_three_values.jpg")
    plt.close()
    ...
    plt.savefig("./training_scores_three_values.jpg")
    plt.close()
    ...
    plt.savefig("./three_values_heatmaps.jpg")
    plt.close()
    ...
    plt.savefig("./three_values_interval_heatmaps.jpg")
